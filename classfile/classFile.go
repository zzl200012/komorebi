...
/* Parse parse a []byte to a class file */
...
/* readAndCheckMagic read the magic number of class file and check whether it's right */
func (cf *ClassFile) readAndCheckMagic(reader *ClassReader) {
	magic := reader.readUint32()
	if magic != 0xcafebabe {
		panic("java.lang.ClassFormatError: Wrong magic number!")
	}
}

/* readAndCheckVersion read the major and minor (not used since j2se 1.2, always be 0)
version of class file and check them */
